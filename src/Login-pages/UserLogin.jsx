                ...
                <div className="border border-light  p-4 mt-5 bg-white removeCorner">
                    <div className="login-form">
                        ...
                        <div className="mb-3">
                            ...
                            <div className="input-group">
                                <input type="password" className="form-control removeCorner" id="password" placeholder="Enter password"  />
                                		<a to="#" className="input-group-text removeCorner" onClick={togglePasswordVisibility} >
                        ...
                        <div className="d-grid py-3 mt-2">
                            <button className="btn btn-lg btn-dark backgroundColorChange removeCorner" onClick={userSignin}>
                                Login
                            </button>
                        </div>
...
function userSignin() {
    ...
    if (email.length == 0) {
        ...
        fetch("http://localhost/Back-end/userSigninProcess.php", {
            method: "POST",
            headers: {
